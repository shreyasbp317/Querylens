import { TableSchema, QueryHistoryItem, SavedQuery } from '../types';
...
// Simulated query results for different prompts
export const mockQueryResults: Record<string, { columns: string[]; rows: Record<string, unknown>[] }> = {
  default: {
